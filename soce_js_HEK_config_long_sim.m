...
figure(3); hold on;plot(x(x_orai),y(y_orai),'bo'); xlim([x(1) x(end)]); ylim([y(1) y(end)])
figure(3); hold on;plot(x(x_serca),y(y_serca),'ro'); xlim([x(1) x(end)]); ylim([y(1) y(end)])
axis(gca,'square')
...
figure(4); hold on;plot(x(x_orai),y(y_orai),'bo'); xlim([x(1) x(end)]); ylim([y(1) y(end)])
figure(4); hold on;plot(x(x_serca),y(y_serca),'ro'); xlim([x(1) x(end)]); ylim([y(1) y(end)])
...
figure(6); hold on;plot(x(x_orai),y(y_orai),'bo'); xlim([x(1) x(end)]); ylim([y(1) y(end)])
figure(6); hold on;plot(x(x_serca),y(y_serca),'ro'); xlim([x(1) x(end)]); ylim([y(1) y(end)])
