...
[XXs,ZZs]=meshgrid(x,zs);


fn_data='/maths/scratch/bhzem/cube/FASEB_sims_20180604/simulated_data/soce_hek_I_orai_9.6e-15_5_Orai_d_orai_14_12_SERCA2b_30nm_ring_dt_1e-05_dx_2_dy_2_dzs_5_m_150_n_150_p_100_T_100_Lb_2000_Lextd_2000/soce-p_5.mat';
fn_serca='/maths/scratch/bhzem/cube/FASEB_sims_20180604/simulated_data/soce_hek_I_orai_9.6e-15_5_Orai_d_orai_14_12_SERCA2b_30nm_ring_dt_1e-05_dx_2_dy_2_dzs_5_m_150_n_150_p_100_T_100_Lb_2000_Lextd_2000/serca_activity.mat';
...
fn_data='/maths/scratch/bhzem/cube/FASEB_sims_20180604/simulated_data/soce_hek_I_orai_9.6e-15_5_Orai_d_orai_88_12_SERCA2b_30nm_ring_dt_1e-05_dx_2_dy_2_dzs_5_m_150_n_150_p_100_T_100_Lb_2000_Lextd_2000/soce-p_5.mat';
fn_serca='/maths/scratch/bhzem/cube/FASEB_sims_20180604/simulated_data/soce_hek_I_orai_9.6e-15_5_Orai_d_orai_88_12_SERCA2b_30nm_ring_dt_1e-05_dx_2_dy_2_dzs_5_m_150_n_150_p_100_T_100_Lb_2000_Lextd_2000/serca_activity.mat';
...
fn_plots_dir='/local/bhzem/R-SOCE/cube/matlab/FASEB_sims_20180604/plots_simulated_data_ring_serca';
...
figure(5)
pcolor(XXs,ZZs,squeeze(cs_d88(:,round(length(y)/2)+round(56/dy),:))')
shading interp
% caxis([cmin_S cmax_S])
colormap(jet)
colorbar
...
figure(15)
pcolor(XXs,ZZs,squeeze(cs_d14(:,round(length(y)/2),:))')
shading interp
% caxis([cmin_S cmax_S])
colormap(jet)
colorbar
...
figure(101)
plot(x,cj_d14(:,round(length(y)/2),end),'b',x,cj_d88(:,round(length(y)/2),end),'r','linewidth',3)
xlabel('x')
xticks([x(1) x(end)])
ylabel('C (\mu M)')
set(gca,'fontsize',30,'fontweight','bold')
set(gca,'OuterPosition',[0 0 .925 1])
savefig('dorai_14_vs_88_slice_PM')

figure(101)
plot(x,cj_d14(:,round(length(y)/2),1),'b',x,cj_d88(:,round(length(y)/2),1),'r','linewidth',3)
xlabel('x')
xticks([x(1) x(end)])
ylabel('C (\mu M)')
set(gca,'fontsize',30,'fontweight','bold')
set(gca,'OuterPosition',[0 0 .925 1])
savefig('dorai_14_vs_88_slice_ERM')
