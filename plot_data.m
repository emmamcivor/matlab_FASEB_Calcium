...
fn_data='/maths/scratch/bhzem/cube/FASEB_sims_20180604/soce_hek_I_orai_9.6e-15_5_Orai_d_orai_14_12_peripheral_SERCA2b_dt_1e-05_dx_2_dy_2_dzs_5_m_150_n_150_p_100_T_100_Lb_2000_Lextd_2000/soce-p_5.mat';
fn_serca='/maths/scratch/bhzem/cube/FASEB_sims_20180604/simulated_data/soce_hek_I_orai_9.6e-15_5_Orai_d_orai_14_12_peripheral_SERCA2b_dt_1e-05_dx_2_dy_2_dzs_5_m_150_n_150_p_100_T_100_Lb_2000_Lextd_2000/serca_actvity.mat';
...
fn_data='/maths/scratch/bhzem/cube/FASEB_sims_20180604/simulated_data/soce_hek_I_orai_9.6e-15_4_Orai_12_SERCA2b_30nm_ring_dt_1e-05_dx_2_dy_2_dzs_5_m_150_n_150_p_100_T_100_Lb_2000_Lextd_2000/soce-p_5.mat';
fn_serca='/maths/scratch/bhzem/cube/FASEB_sims_20180604/simulated_data/soce_hek_I_orai_9.6e-15_4_Orai_12_SERCA2b_30nm_ring_dt_1e-05_dx_2_dy_2_dzs_5_m_150_n_150_p_100_T_100_Lb_2000_Lextd_2000/serca_actvity.mat';
...
mkdir plots_simulated_data_ring_serca
cd plots_simulated_data_ring_serca
...
figure(4)
pcolor(X,Y,cs_d88(:,:,end))
shading interp
caxis([cmin_S cmax_S])
colormap(jet)
colorbar
savefig('dorai_88_sub_ERM')

figure(5)
% pcolor(XXs,ZZs,squeeze(cs_d88(:,round(length(y)/2)+round(135/dy),:))')
pcolor(XXs,ZZs,squeeze(cs_d88(:,round(length(y)/2),:))')
shading interp
caxis([cmin_S cmax_S])
colormap(jet)
colorbar
...
figure(14)
pcolor(X,Y,cs_d14(:,:,end))
shading interp
caxis([cmin_S cmax_S])
colormap(jet)
colorbar
savefig('dorai_14_sub_ERM')

figure(15)
% pcolor(XXs,ZZs,squeeze(cs_d14(:,round(length(y)/2)+round(135/dy),:))')
